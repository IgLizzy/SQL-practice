...
with cte9 as(
	select e1.flight_id, 
	e1.passenger_name, e1.passenger_id,
	a.city as departure, (a.longitude ||','|| a.latitude) as point_departure,
	e1.arrival, point_arrival, e1.amount
	from 
		(select f.flight_id, f.departure_airport, f.arrival_airport, 
		tf.amount, t.passenger_name, t.passenger_id, a.city as arrival,
		(a.longitude ||','|| a.latitude) as point_arrival
		from flights f 
...
select *--, earth_distance(cte9.point_departure, cte9.point_arrival)
from cte9
